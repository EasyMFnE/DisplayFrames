 ...
 * shutdown operations. Maintains instances of ConfigHelper,
 * DisplayFramesCommand, and PlayerListener.
 * 
 * @author Eric Hildebrand
 */
public class DisplayFrames extends JavaPlugin {
    
    private ConfigHelper configHelper = null;
    private DisplayFramesCommand displayFramesCommand = null;
    private PlayerListener playerListener = null;
    
    /* Strings for fancyLog() methods */
    private final String logPrefix = ChatColor.BLUE + "[DisplayFrames] ";
    ...
    public void onDisable() {
        ...
        playerListener = null;
        displayFramesCommand.close();
        displayFramesCommand = null;
        configHelper = null;
     ...
     * existent), then instantiating its own ConfigHelper, DisplayFramesCommand,
    ...
    public void onEnable() {
        ...
        Localization.load(this, configHelper.getLocaleName());
        fancyLog("Using locale: " + Localization.getLocaleName());
        displayFramesCommand = new DisplayFramesCommand(this);
